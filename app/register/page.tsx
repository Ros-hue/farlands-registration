    ...
    <main className="register-page">
      <section className="register-card">
        ...
        <form onSubmit={submit}>
          ...
          <button className="register-pay" disabled={creating}>{creating ? "Creating team…" : "Continue to secure Google Pay / UPI payment · ₹1,000"}</button>
          <div style={{ marginTop: "16px", textAlign: "center", fontSize: "0.9rem", color: "#a9bca5" }}>
            Already registered?{" "}
            <Link href="/login" style={{ color: "#a5df7a", fontWeight: "bold", textDecoration: "none" }}>
              Sign in to payment portal
            </Link>
          </div>
        </form>
      </section>
